...
const questions = [
  {
    question: 'Vous dormiez jusqu’au moment où un moustique est venu voler juste au-dessus de votre lit :',
    answers: [{
      ...
      title: "Vous filez chercher de la bombe anti-moustiques et vous en aspergez la chambre",
      house: 'WildBee'

    }, {
      title: "Vous vous enfoncez dans votre lit sans laisser dépasser un centimère de peau",
      house: 'WildTurtle'
    }]
  },
  {
  ...
  {
    question: 'Selon vous, la qualité primordiale pour qu’un homme politique reste longtemps au pouvoir :',
    answers: [{
